...
const ContactForm=()=> {
  ...
  if (state.succeeded) {
    return (
      <k className="w-full text-center">
        <p className="text-2xl md:text-5xl">
          Thanks for joining!{" "}
          <span className="text-sm">(Refresh for resend message!)</span>
        </p>
      </k>
    );
  }
  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="mt-24 mb-4 text-center text-4xl "
      >
        {" "}
        Contact
      </motion.h1>
      ...
      <form
        ...
        className="text-stone-400 flex flex-col gap-4 w-[60%] p-5 text-center mx-auto "
      >
        ...
        <button
          ...
          className=" bg-stone-500  hover:bg-stone-600  w-36 h-10 mx-auto rounded-md p-2"
        >
          Send Message
        </button>
      </form>
